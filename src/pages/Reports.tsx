...
const REPORTING_VIEWS = [
  ...
  },
  {
    ...
    type: 'Fact',
    columns: 'attendance_id, college_code, batch_code, course_name, register_no, session_date, hour_no, attendance_status',
  ...
  },
  {
    ...
    type: 'Fact',
    columns: 'mark_id, college_code, batch_code, course_name, assessment_name, register_no, mark, max_mark, percentage',
  ...
  },
  {
    ...
    type: 'Summary',
    columns: 'student_id, register_no, batch_code, course_name, sessions_held, present_count, absent_count, attendance_pct',
