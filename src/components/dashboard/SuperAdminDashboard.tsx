  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">Overview of the entire academic platform.</p>
      </div>
            ...
            <div className="h-[300px]">
              <ResponsiveContainer width="100%" height="100%">
                <LineChart data={data}>
                  ...
                  <YAxis className="text-xs" />
                  <Tooltip />
                  <Line type="monotone" dataKey="courses" stroke="currentColor" strokeWidth={2} className="stroke-primary" />
                </LineChart>
              </ResponsiveContainer>
            </div>
          </CardContent>
